...
// The largest purpose of using controllers is to separate the functionality from routes. Controllers will handle the functionality and routes will point to controller methods.
